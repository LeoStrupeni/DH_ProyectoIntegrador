        ...
        <div class="modal-content">
            ...
            <div class="modal-body body-register">
                <form method="POST" action="{{ route('register') }}" enctype="multipart/form-data"
                    ...
                    <div class="form-group row email-section">
                        <label for="email"
                    ...
                    <div class="form-group row">
                        <label for="personal_id" class="col-md-4 col-form-label text-md-right font-weight-bold"
                            id="label-id">{{ __('CUIT/CUIL') }}</label>
