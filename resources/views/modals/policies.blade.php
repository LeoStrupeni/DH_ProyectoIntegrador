<button type="button" class="list-group-item btn-foot" data-toggle="modal" data-target="#modalPolicies">
    ...
    <div class="modal-dialog modal-dialog-scrollable modal-lg" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body text-justify">
                <p>El presente Política de Privacidad establece los términos en que <strong><i>CAPONE SA</i></strong>
                    usa y protege la información que es proporcionada por sus usuarios al momento de utilizar su sitio
                    ...
                    hacemos asegurando que sólo se empleará de acuerdo con los términos de este documento. Sin embargo
                    ...
                    cambios.</p>
                <br>
                <p class="h4">Información que es recogida</p>
                <p>Nuestro sitio web podrá recoger información personal por ejemplo: Nombre, información de contacto
                    ...
                    facturación.</p>
                <p class="h4">Uso de la información recogida</p>
                ...
                <p><strong><i>CAPONE SA</i></strong> está altamente comprometido para cumplir con el compromiso de
                    mantener su información segura. Usamos los sistemas más avanzados y los actualizamos constantemente
                    para asegurarnos que no exista ningún acceso no autorizado.</p>
                <p class="h4">Cookies</p>
                <p>Una cookie se refiere a un fichero que es enviado con la finalidad de solicitar permiso para
                    ...
                    por tanto brindarte el mejor servicio personalizado de su web.</p>
                <p>Nuestro sitio web emplea las cookies para poder identificar las páginas que son visitadas y su
                    ...
                    quiera y la proporcione directamente, visitas a una web . Usted puede aceptar o negar el uso de
                ...
                <p class="h4">Enlaces a Terceros</p>
                ...
                <p class="h4">Control de su información personal</p>
                ...
                <p><strong><i>CAPONE SA</i></strong> Se reserva el derecho de cambiar los términos de la presente
