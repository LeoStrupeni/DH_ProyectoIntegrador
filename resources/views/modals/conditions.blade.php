    ...
    <div class="modal-dialog modal-dialog-scrollable modal-lg" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h4 class="modal-title m-auto" id="modalConditions">Términos y Condiciones de Uso</h4>
            ...
            <div class="modal-body text-justify">
                ...
                <br>
                <p>Estas terminos y condiciones se han generado en terminosycondicionesdeusoejemplo.com.</p>
            </div>
        </div>
    </div>
</div>