  ...
  <div class="row">
    <div class="col-10 col-md-9">
      <nav class="navbar navbar-expand-md navbar-light bg-transparent">
        ...
        <button class="navbar-toggler btn bg-dark btn-lg btn-block" type="button" data-toggle="collapse" data-target="#navbarSupportedContent"
    ...
    <div class="col-2 col-md-2">
      <button class="btn btn-danger btn-lg login" type="submit">
